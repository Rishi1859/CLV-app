...
if uploaded_file:
    ...
    # Drop missing customer IDs and negative quantities
    ...
    # -------------------------------
    st.markdown("---")
    st.markdown("✅ **Built with Streamlit** | Author: *ChatGPT x Rishi*")
